...
public class RopeableLanternBlock extends Block implements Waterloggable {
    ...
    public BlockState updatePostPlacement(BlockState stateIn, Direction facing, BlockState facingState, IWorld worldIn, BlockPos currentPos, BlockPos facingPos) {
        ...
        return func_220277_j(stateIn).getOpposite() == facing && !stateIn.canPlaceAt(worldIn, currentPos) ? Blocks.AIR.getDefaultState() : super.updatePostPlacement(stateIn, facing, facingState, worldIn, currentPos, facingPos);
    }
    ...
    public boolean allowsMovement(BlockState state, BlockReader worldIn, BlockPos pos, PathType type) {
        return false;
    }
}
